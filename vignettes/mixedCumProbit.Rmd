...
samp <- sample_theta_y(sim$x,sim$Y,hp,10,20,verbose=F,start=theta_y0_list)
bundle <- bundle_theta_y_sample(samp,sim$x,sim$Y,hp,varNames=c('ord1','ord2','cont1','cont2'),known=list(theta_y=theta_y0_list))
print(names(bundle))
```
...
```{r}
samp2 <- sample_theta_y(sim$x,sim$Y,hp,10,20,verbose=F)
bundle2 <- bundle_theta_y_sample(samp2,sim$x,sim$Y,hp,varNames=c('ord1','ord2','cont1','cont2'),known=list(theta_y=theta_y0_list))
print(names(bundle))
```
